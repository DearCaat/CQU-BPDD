...
### Download CQU-BPDD
Downloading the dataset: [Baidu](https://pan.baidu.com/share/init?surl=nEwGiKZpmwyIq97YV8qdqQ&pwd=mq0a), [Huggingface](https://huggingface.co/datasets/Dearcat/CQU-BPDD). _Please note: CQU-BPDD can be only used in the uncommercial case._
